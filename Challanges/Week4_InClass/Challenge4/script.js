function generate_board() {
    ...
    for(friend of selectFriends){
        randomized.push("apple_" + friend.value + ".png");
        randomized.push("banana_" + friend.value + ".png");
        randomized.push("kiwi_" + friend.value + ".png");
        randomized.push("orange_" + friend.value + ".png");
    }
    ...
    for (friend of randomized){
        counter += 1;
        if (counter % 4 == 0){
            pictureStr = pictureStr + '<img src="cards/'+ friend +'"> </div> <div>';
        }
        else{
            pictureStr = pictureStr + '<img src="cards/'+ friend +'">';
        }
