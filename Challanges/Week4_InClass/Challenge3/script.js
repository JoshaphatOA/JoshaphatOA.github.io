...
function show(button_element) {
    ...
    */
    ...
    if(buttonBuffer != ""){
        document.getElementById(buttonBuffer).style.backgroundColor = "darkblue";
        document.getElementById(buttonBuffer).style.color = "white";
        
    }
    buttonBuffer = button_element.id;
